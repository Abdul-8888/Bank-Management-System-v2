...
{
    public partial class blockCustomerForm : Form
    {
        private Employee manager;

        public blockCustomerForm(Employee manager)
        {
            InitializeComponent();
            this.manager = manager;
        }

        private void blockCustomerForm_Load(object sender, EventArgs e)
        {
        ...
        {
            CustomerDL.deleteCustomer(CustomerDL.getCustomer(txtUsername.Text).ToString());
            MessageBox.Show("Customer Account Blocked");
            txtUsername.Text = "";
